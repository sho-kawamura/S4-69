const ShapeService = function() {
    ...
    this.gridLeftRate = 0.09;   // canvas高さ何割分をグリッド横の幅にするか
    this.cellSizeRate = 0.04445;   // canvas高さ何割分をセル1個分の大きさにするか
    this.cellsWidth = 21;       // セルの個数（横）
    this.cellsHeight = 12;      // セルの個数（縦）
